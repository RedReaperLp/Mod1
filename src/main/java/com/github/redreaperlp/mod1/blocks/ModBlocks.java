...
public class ModBlocks {
    ...
    public static final Block RUBY_ORE_DEEPSLATE = registerBlocks("ruby_ore_deepslate",
            new Block(FabricBlockSettings.of(Material.STONE).strength(4.0f, 3.0f).requiresTool()), ItemGroupBuilder.MODItemGroup);

    public static final Block RUBY_ORE_NETHER = registerBlocks("ruby_ore_nether",
            new Block(FabricBlockSettings.of(Material.STONE).strength(3.0f, 3.0f).requiresTool()), ItemGroupBuilder.MODItemGroup);

    public static final Block RUBY_ORE_END = registerBlocks("ruby_ore_end",
            new Block(FabricBlockSettings.of(Material.STONE).strength(4.0f, 3.0f).requiresTool()), ItemGroupBuilder.MODItemGroup);

    public static final Block JUMPY_BLOCK = registerBlocks("jumpy_block",
            new JumpyBlock(FabricBlockSettings.of(Material.STONE).strength(1.0f, 3.0f).requiresTool()), ItemGroupBuilder.MODItemGroup);

    public static final Block RUBY_LAMP = registerBlocks("ruby_lamp",
    ...
    public static void registerBlockss() {
    }
}
